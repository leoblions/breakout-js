...
export class Input {
  ...
  resetDflags () {
    this.dflags.up = false
    this.dflags.down = false
    this.dflags.left = false
    this.dflags.right = false
  }
  ...
  menuMotion () {
    ...
    if (keys[' '] == true) {
      ...
      this.game.ball.serve()
    }

    this.dflags.up = keys['ArrowUp'] === true
    this.dflags.down = keys['ArrowDown'] === true
    this.dflags.left = keys['ArrowLeft'] === true
    this.dflags.right = keys['ArrowRight'] === true

    if (keys['w'] === true) this.dflags.up = true
    if (keys['s'] === true) this.dflags.down = true
    if (keys['a'] === true) this.dflags.left = true
    if (keys['d'] === true) this.dflags.right = true
    ...
    if (keys['k'] == true) {
      this.game.brickgrid.killAllBricks()
    }
    if (keys['l'] == true) {
